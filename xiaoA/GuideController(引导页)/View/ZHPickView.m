...
-(void)setUpPickView{
    ...
    pickView.frame=CGRectMake(0, ZHToobarHeight, KviewWidth, pickView.frame.size.height);
...
-(void)setUpDatePickerWithdatePickerMode:(UIDatePickerMode)datePickerMode{
    ...
    datePicker.frame=CGRectMake(0, ZHToobarHeight, KviewWidth, datePicker.frame.size.height);
...
-(UIToolbar *)setToolbarStyle{
    ...
    //占位
    UIBarButtonItem *right1=[[UIBarButtonItem alloc] initWithTitle:@"" style:UIBarButtonItemStylePlain target:self action:nil];
    
    //占位
    UIBarButtonItem *right2=[[UIBarButtonItem alloc] initWithTitle:@"" style:UIBarButtonItemStylePlain target:self action:nil];
    
   // toolbar.items=@[centerSpace,right,right1];
    toolbar.items=@[right1,lefttem,centerSpace,right,right2];
    return toolbar;
}
